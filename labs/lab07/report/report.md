...
subtitle: "Лабораторная работа номер 7"
...
2)Вызываем mc, изучаем его структуру и меню (рис. @fig:002).

![Команда mc](image/2.png){#fig:002 width=90%}

5)Просматриваем содержимое текстового файла (рис. @fig:003).

![Просмотр содержимого файла](image/3.png){#fig:003 width=90%}

Редактируем текст и не сохраняем изменения (рис. @fig:004).

![F10](image/4.png){#fig:004 width=90%}

Создаем новый каталог (рис. @fig:005).

![Каталог tatari](image/5.png){#fig:005 width=90%}

Копируем файлы в создынный каталог (рис. @fig:006).

![Копирование файлов](image/6.png){#fig:006 width=90%}

6)Повторяем одну из предыдущих команд (рис. @fig:007).

![Повторение команды touch](image/7.png){#fig:007 width=90%}

Переходим в домашний каталог (рис. @fig:008).

![cd](image/8.png){#fig:008 width=90%}

Анализ файла меню (рис. @fig:009).

![файл меню](image/9.png){#fig:009 width=90%}

Анализ файла расширений (рис. @fig:010).

![файл расширений](image/10.png){#fig:010 width=90%}

Осваиваем операции, определяющие структуру экрана mc. (рис. @fig:011).

![подменю настройки](image/11.png){#fig:011 width=90%}

# Задание по встроенному редактору mc

1)Создаем файловый текст (рис. @fig:012).

![Команда touch](image/12.png){#fig:012 width=90%}

2)Открываем файл в редакторе (рис. @fig:013).

![F4](image/13.png){#fig:013 width=90%}

3)Вставляем текст в файл (рис. @fig:014).

![Монолог Джулса из криминального чтива](image/14.png){#fig:014 width=90%}

4)Удаляем строку текста (рис. @fig:015).

![CTRL-y](image/15.png){#fig:015 width=90%}

Выделяем фрагмент и копируем на новую строку (рис. @fig:016).

![F3, F6](image/16.png){#fig:016 width=90%}

Сохраняем файл (рис. @fig:017).

![F2](image/17.png){#fig:017 width=90%}

Отменяем послденее действие (рис. @fig:018).

![CTRL-u](image/18.png){#fig:018 width=90%}

Переходим в конец файла (рис. @fig:019).

![CTRL-END](image/19.png){#fig:019 width=90%}

Переходим в начало файла (рис. @fig:020).

![CTRL-HOME](image/20.png){#fig:020 width=90%}

Сохраняем и закрываем файл (рис. @fig:021).

![F10](image/21.png){#fig:021 width=90%}

5)Открываем файл с исходным текстом на некотором языке программирования (рис. @fig:022).

![F4](image/22.png){#fig:022 width=90%}

6)Выключаем подсветку (рис. @fig:023).
...
ext3. – редактировать файл расширений — позволяет задать с помощью определённого синтаксиса действия при запуске файлов с определённым расширением (например, какое программного обеспечение запускать для открытия или редактирования файлов с расширением doc или docx). – редактировать файл меню — позволяет отредактировать контекстное меню пользователя, вызываемое по клавише F2. – редактировать файл расцветки имён — позволяет подобрать оптимальную для пользователя расцветку имён файлов в зависимости от их типа.
