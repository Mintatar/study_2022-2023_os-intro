...
Пишем командный файл, реализующий упрощенный механизм семафоров. (рис. @fig:001).

![Командный файл](image/1.png){#fig:001 width=70%}

Реализовываем команду man с помощью командного файла (рис. @fig:002).

![Командный файл](image/2.png){#fig:002 width=70%}

Пишем командный файл, генерирующий случайную последовательность букв латинского алфавита. (рис. @fig:003).
